...
- [x] Test a clean install, upgrade, uninstall, Accessibility permissions, Screen Recording permissions, login item behavior, and side-by-side behavior with official AltTab (evidence in [docs/source-first-audit.md](docs/source-first-audit.md); exhaustive TCC revoke matrix remains optional post-milestone QA).
