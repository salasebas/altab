...
class SettingsWindow: NSWindow {
    ...
    private func setupContentPane() {
        ...
        sectionsStack.bottomAnchor.constraint(equalTo: sectionsDocumentView.bottomAnchor, constant: -Self.contentBottomPadding).isActive = true
    }
    ...
    private func addSection(_ definition: SettingsSectionDefinition) {
        ...
        // call inside (`LabelAndControl.makeDropdown`, `TableGroupView.makeText`, etc.) pushes its
        // searchable strings and highlight targets into a per-section `Builder`.
